# Experiment History — Flood Forecasting Model Evolution

> ⚠️ **This document records historical experiments from earlier development phases.** The metrics below belong to different model versions and pipelines. They are **not** the current deployed model's results. See [`README.md`](README.md) for current evaluation.
...
- **Deep Learning Benchmark Metrics (this phase only)**:
...
- **Hindcast Benchmark Metrics (this phase only, Random Forest model)**:
